 ...
 */
const memberWelcomeTemplate = (name, email, password, role) => `
...
const adminForgotPasswordTemplate = (name, resetUrl, minutes = 10) => `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
const AdminLoginTemplate = (name, token, minutes = 3) => `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 8px; background: #f9f9f9;">
    <h2 style="color: #2E86C1; text-align:center;">🔐 Admin Login Verification</h2>
    <p>Hi <b>${name}</b>,</p>
